            ...
            using (var check = new EditorGUI.ChangeCheckScope ()) {
                ...
                if (data.showPathOptions) {
                    ...
                    if (handleIndexToDisplayAsTransform != -1) {
                        ...
                        // Debug.Log("anchor-index:"+handleIndexToDisplayAsTransform.ToString());

                        // Debug.Log(creator.bezierPath.isEmpty.Count+" sayi");
                        EditorGUI.BeginChangeCheck();
                        creator.bezierPath.isEmpty[handleIndexToDisplayAsTransform] = EditorGUILayout.Toggle("Is Empty", creator.bezierPath.isEmpty[handleIndexToDisplayAsTransform]);
            ...
            if (mouseOverHandleIndex == -1) {
                if (e.type == EventType.MouseDown && e.button == 0 && e.shift) {
                    ...
                    if (selectedSegmentIndex != -1 && selectedSegmentIndex < bezierPath.NumSegments) {
                        ...
                        //Debug.Log("selectedSegmentIndex " + selectedSegmentIndex.ToString());
                    }
                    //todo
