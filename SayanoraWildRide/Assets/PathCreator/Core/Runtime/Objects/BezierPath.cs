...
namespace PathCreation {
    ...
    public class BezierPath {
       ...
       public List<bool> isEmpty= new List<bool> { false,false,false,false};
...
[SerializeField, HideInInspector]
 ...
 IsClosed = isClosed;
        ...
        public void AddSegmentToEnd (Vector3 anchorPos) {
           ...
           // Debug.Log("lastAnchorIndex " + lastAnchorIndex.ToString());
        ...
        public void AddSegmentToStart (Vector3 anchorPos) {
            ...
            isEmpty.Insert(0,false);
            isEmpty.Insert(1,false);
            isEmpty.Insert(2,false);
        ...
        public void SplitSegment (Vector3 anchorPos, int segmentIndex, float splitTime) {
            ...
            if (controlMode == ControlMode.Automatic) {
               // Debug.Log("segmentIndex * 3 + 3"+ (segmentIndex * 3 + 3).ToString());
                isEmpty.InsertRange(segmentIndex * 3 + 2, new bool[] { false, false, false } );
